"use strict";
(self["webpackChunkvideo"] = self["webpackChunkvideo"] || []).push([["524"], {
...
5858(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: ADTS, MP4, MPEG_TS, WAVE, MATROSKA, AdtsInputFormat, HLS_FORMATS, Mp3InputFormat, Mp4InputFormat, QuickTimeInputFormat, WEBM, FlacInputFormat, IsobmffInputFormat, MpegTsInputFormat, MP3, OGG, QTFF, HLS, OggInputFormat, WaveInputFormat, FLAC, MatroskaInputFormat, WebMInputFormat
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/aes.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/isobmff/isobmff-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class IsobmffDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.moovSlice = null;
    ...
    getSampleTableForTrack(internalTrack) {
        ...
        const isPcmCodec = internalTrack.info?.type === 'audio'
            ...
            && src_codec/* .PCM_AUDIO_CODECS.includes */.Wq.includes(internalTrack.info.codec);
        if (isPcmCodec && sampleTable.sampleCompositionTimeOffsets.length === 0) {
            ...
            const pcmInfo = (0,src_codec/* .parsePcmCodec */.Ei)(internalTrack.info.codec);
        ...
        switch (boxInfo.name) {
            ...
            case 'trak':
                {
                    const track = {
                        ...
                        trackBacking: null,
                        disposition: {
                            ...src_metadata/* .DEFAULT_TRACK_DISPOSITION */.gM,
                            primary: false,
                        },
                        info: null,
                        timescale: -1,
            ...
            case 'elst':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        ...
                        if (relevantEntryFound) {
                            logging/* .Logging._warn */.y._warn('Unsupported edit list: multiple edits are not currently supported. Only using first edit.');
                            break;
                        }
                        if (mediaTime === -1) {
                        ...
                        if (mediaRate !== 1) {
                            logging/* .Logging._warn */.y._warn('Unsupported edit list entry: media rate must be 1.');
                            break;
                        }
            ...
            case 'stsd':
                {
                    ...
                    for (let i = 0; i < entries; i++) {
                        ...
                        if (track.info.type === 'video') {
                            ...
                            else if (src_codec/* .PRORES_FOURCCS.includes */.Y2.includes(lowercaseBoxName)) {
                                track.info.codec = 'prores';
                                track.info.proresFormat = lowercaseBoxName;
                            }
                            else if (codecName === null) {
                                logging/* .Logging._warn */.y._warn(`Unknown encrypted video codec due to missing frma box.`);
                            }
                            else {
                                logging/* .Logging._warn */.y._warn(`Unsupported video codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
                        else {
                            slice.skip(6 * 1 + 2);
                            ...
                            if (codecName === 'mp4a') {
                                ...
                                track.info.sampleRate = src_codec/* .OPUS_SAMPLE_RATE */.yo; // Always the same
                            }
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    logging/* .Logging._warn */.y._warn(`Unsupported sample size ${sampleSize} for codec 'twos'.`);
                                ...
                                if (sampleSize === 8) {
                                    ...
                                    logging/* .Logging._warn */.y._warn(`Unsupported sample size ${sampleSize} for codec 'sowt'.`);
                                    track.info.codec = null;
                                }
                            }
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 16) {
                                        ...
                                        logging/* .Logging._warn */.y._warn(`Invalid ipcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.pcmLittleEndian) {
                                    if (pcmSampleSize === 32) {
                                        ...
                                        logging/* .Logging._warn */.y._warn(`Invalid fpcm sample size ${pcmSampleSize}.`);
                                        track.info.codec = null;
                                    }
                                }
                                else {
                                ...
                                if (track.info.codec === null) {
                                    logging/* .Logging._warn */.y._warn('Unsupported PCM format.');
                                }
                            }
                            else if (codecName === null) {
                                logging/* .Logging._warn */.y._warn(`Unknown encrypted audio codec due to missing frma box.`);
                            }
                            else {
                                logging/* .Logging._warn */.y._warn(`Unsupported audio codec (sample entry type '${sampleBoxInfo.name}').`);
                            }
                        }
            ...
            case 'schm':
                {
                    ...
                    if (schemeType === 'cenc' || schemeType === 'cens' || schemeType === 'cbcs') {
                        ...
                        logging/* .Logging._warn */.y._warn(`Unsupported encryption scheme '${schemeType}'.`);
                    }
                }
                ;
                break;
            ...
            case 'esds':
                {
                    ...
                    if (objectTypeIndication === 0x40 || objectTypeIndication === 0x67) {
                        ...
                        logging/* .Logging._warn */.y._warn(`Unsupported audio codec (objectTypeIndication ${objectTypeIndication}) - discarding track.`);
                    }
                    slice.skip(1 + 3 + 4 + 4);
            ...
            case 'dfLa':
                { // Used for FLAC audio
                    ...
                    while (slice.filePos < boxEndPos) {
                        ...
                        if (type === codec_data/* .FlacBlockType.STREAMINFO */.A3.STREAMINFO) {
                            slice.skip(10);
            ...
            case 'dec3':
                { // EC3SpecificBox
                    ...
                    if (!config) {
                        logging/* .Logging._warn */.y._warn('Invalid dec3 box contents, ignoring.');
                        break;
                    }
            ...
            case 'saio':
                {
                    ...
                    if (entryCount > 1) {
                        logging/* .Logging._warn */.y._warn('Multiple saio entries are not supported; using the first offset only.');
                    }
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        ...
                        switch (boxInfo.name) {
                            ...
                            case 'name':
                                {
                                    if (this.currentTrack) {
                                        this.currentTrack.name = misc/* .textDecoder.decode */.su.decode((0,src_reader/* .readBytes */.io)(slice, boxInfo.contentSize));
                                    }
                                    else {
            ...
            case 'keys':
                {
                    ...
                    for (let i = 0; i < entryCount; i++) {
                        ...
                        const keyName = misc/* .textDecoder.decode */.su.decode((0,src_reader/* .readBytes */.io)(slice, keySize - 8));
                    ...
                    for (const { boxInfo, slice } of iterator) {
                        ...
                        switch (metadataKey) {
                            ...
                            case 'com.apple.quicktime.artwork':
                                {
                                    if (data instanceof src_metadata/* .RichImageData */.sF) {
...
class IsobmffVideoTrackBacking extends IsobmffTrackBacking {
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            ...
            const config = {
                codec: (0,src_codec/* .extractVideoCodecString */.QP)(this.internalTrack.info),
...
class IsobmffAudioTrackBacking extends IsobmffTrackBacking {
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfig ??= {
            codec: (0,src_codec/* .extractAudioCodecString */.X0)(this.internalTrack.info),
...
const decryptSample = async (track, sampleEncryption, data, fragment) => {
    ...
    if (cacheEntry) {
        ...
        const promise = (async () => {
            ...
            if (!((typeof keyResult === 'string' && keyResult.length === 32 && misc/* .HEX_STRING_REGEX.test */.Sn.test(keyResult))
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/matroska/matroska-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
var matroska_demuxer_BlockLacing;
...
})(matroska_demuxer_BlockLacing || (matroska_demuxer_BlockLacing = {}));
var matroska_demuxer_ContentEncodingScope;
...
})(matroska_demuxer_ContentEncodingScope || (matroska_demuxer_ContentEncodingScope = {}));
var matroska_demuxer_ContentCompAlgo;
...
})(matroska_demuxer_ContentCompAlgo || (matroska_demuxer_ContentCompAlgo = {}));
const METADATA_ELEMENTS = [
    { id: ebml/* .EBMLId.SeekHead */.Cl.SeekHead, flag: 'seekHeadSeen' },
    { id: ebml/* .EBMLId.Info */.Cl.Info, flag: 'infoSeen' },
    { id: ebml/* .EBMLId.Tracks */.Cl.Tracks, flag: 'tracksSeen' },
    { id: ebml/* .EBMLId.Cues */.Cl.Cues, flag: 'cuesSeen' },
];
const MAX_RESYNC_LENGTH = 10 * 2 ** 20; // 10 MiB
class MatroskaDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
    ...
    readMetadata() {
        return this.readMetadataPromise ??= (async () => {
            ...
            while (true) {
                ...
                if (id === ebml/* .EBMLId.EBML */.Cl.EBML) {
                ...
                else if (id === ebml/* .EBMLId.Segment */.Cl.Segment) { // Segment found!
                ...
                else if (id === ebml/* .EBMLId.Cluster */.Cl.Cluster) {
                    if (this.reader.fileSize === null) {
    ...
    async readSegment(segmentDataStart, dataSize) {
        ...
        while (this.currentSegment.elementEndPos === null || currentPos < this.currentSegment.elementEndPos) {
            ...
            const header = (0,ebml/* .readElementHeader */.ur)(slice);
            if (!header || (!ebml/* .LEVEL_1_EBML_IDS.includes */.VE.includes(header.id) && header.id !== ebml/* .EBMLId.Void */.Cl.Void)) {
            ...
            else if (id === ebml/* .EBMLId.Tags */.Cl.Tags || id === ebml/* .EBMLId.Attachments */.Cl.Attachments) {
                // Metadata found at the beginning of the segment, great, let's parse it
                if (id === ebml/* .EBMLId.Tags */.Cl.Tags) {
    ...
    async readCluster(startPos, segment) {
        ...
        (0,misc/* .assert */.vA)(id === ebml/* .EBMLId.Cluster */.Cl.Cluster);
        ...
        for (const [, trackData] of cluster.trackData) {
            ...
            for (let i = 0; i < trackData.blocks.length; i++) {
                ...
                hasLacedBlocks ||= block.lacing !== matroska_demuxer_BlockLacing.None;
            }
            ...
            for (let i = 0; i < trackData.presentationTimestamps.length; i++) {
                ...
                if (i < trackData.presentationTimestamps.length - 1) {
                    ...
                    if (track.defaultDuration != null) {
                        if (currentBlock.lacing === matroska_demuxer_BlockLacing.None) {
    ...
    expandLacedBlocks(blocks, track) {
        ...
        for (let blockIndex = 0; blockIndex < blocks.length; blockIndex++) {
            ...
            if (originalBlock.lacing === matroska_demuxer_BlockLacing.None) {
                continue;
            }
            ...
            const slice = src_reader/* .FileSlice.tempFromBytes */.x$.tempFromBytes(originalBlock.data);
            const frameSizes = [];
            const frameCount = (0,src_reader/* .readU8 */.eo)(slice) + 1;
            switch (originalBlock.lacing) {
                case matroska_demuxer_BlockLacing.Xiph:
                    {
                        let totalUsedSize = 0;
                    ...
                    ;
                    break;
                case matroska_demuxer_BlockLacing.FixedSize:
                    {
                    ...
                    ;
                    break;
                case matroska_demuxer_BlockLacing.Ebml:
                    {
            ...
            for (let i = 0; i < frameCount; i++) {
                ...
                blocks.splice(blockIndex + i, 0, {
                    ...
                    data: frameData,
                    lacing: matroska_demuxer_BlockLacing.None,
                    decoded: true,
                    postProcessed: false,
    ...
    async loadSegmentMetadata(segment) {
        for (const seekEntry of segment.seekEntries) {
            if (seekEntry.id === ebml/* .EBMLId.Tags */.Cl.Tags && !segment.tagsSeen) {
                // We need to load the tags
            }
            else if (seekEntry.id === ebml/* .EBMLId.Attachments */.Cl.Attachments && !segment.attachmentsSeen) {
            ...
            this.currentSegment = null;
            // Mark as seen
            if (seekEntry.id === ebml/* .EBMLId.Tags */.Cl.Tags) {
                segment.tagsSeen = true;
            }
            else if (seekEntry.id === ebml/* .EBMLId.Attachments */.Cl.Attachments) {
    ...
    traverseElement(slice, stopIds) {
        ...
        (0,ebml/* .assertDefinedSize */.p)(size);
        switch (id) {
            case ebml/* .EBMLId.DocType */.Cl.DocType:
                {
                    this.isWebM = (0,ebml/* .readAsciiString */.IX)(slice, size) === 'webm';
                }
                ;
                break;
            case ebml/* .EBMLId.Seek */.Cl.Seek:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.SeekID */.Cl.SeekID:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.SeekPosition */.Cl.SeekPosition:
                {
                    const lastSeekEntry = this.currentSegment?.seekEntries[this.currentSegment.seekEntries.length - 1];
                    if (!lastSeekEntry)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.TimestampScale */.Cl.TimestampScale:
                {
                    if (!this.currentSegment)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Duration */.Cl.Duration:
                {
                    if (!this.currentSegment)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.TrackEntry */.Cl.TrackEntry:
                {
                    if (!this.currentSegment)
                        break;
                    this.currentTrack = {
                    ...
                    if (this.currentTrack.decodingInstructions.some((instruction) => {
                        return instruction.data?.type !== 'decompress'
                            || instruction.scope !== matroska_demuxer_ContentEncodingScope.Block
                            || instruction.data.algorithm !== matroska_demuxer_ContentCompAlgo.HeaderStripping;
                    })) {
                        logging/* .Logging._warn */.y._warn(`Track #${this.currentTrack.id} has an unsupported content encoding; dropping.`);
                        this.currentTrack = null;
                    }
                    if (this.currentTrack
                        ...
                        if (this.currentTrack.info.type === 'video'
                            ...
                            if (this.currentTrack.codecId === ebml/* .CODEC_STRING_MAP.avc */.oo.avc) {
                                this.currentTrack.info.codec = 'avc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (this.currentTrack.codecId === ebml/* .CODEC_STRING_MAP.hevc */.oo.hevc) {
                                this.currentTrack.info.codec = 'hevc';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.vp8 */.oo.vp8) {
                                this.currentTrack.info.codec = 'vp8';
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.vp9 */.oo.vp9) {
                                this.currentTrack.info.codec = 'vp9';
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.av1 */.oo.av1) {
                                this.currentTrack.info.codec = 'av1';
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.prores */.oo.prores) {
                                const format = this.currentTrack.codecPrivate
                                    ? misc/* .textDecoder.decode */.su.decode(this.currentTrack.codecPrivate)
                                    : '';
                                if (src_codec/* .PRORES_FOURCCS.includes */.Y2.includes(format)) {
                            ...
                            if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.aac */.oo.aac) {
                            ...
                            else if (this.currentTrack.codecId === ebml/* .CODEC_STRING_MAP.mp3 */.oo.mp3) {
                                this.currentTrack.info.codec = 'mp3';
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.opus */.oo.opus) {
                                this.currentTrack.info.codec = 'opus';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                                this.currentTrack.info.sampleRate = src_codec/* .OPUS_SAMPLE_RATE */.yo; // Always the same
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.vorbis */.oo.vorbis) {
                                this.currentTrack.info.codec = 'vorbis';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.flac */.oo.flac) {
                                this.currentTrack.info.codec = 'flac';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.ac3 */.oo.ac3) {
                                this.currentTrack.info.codec = 'ac3';
                                this.currentTrack.info.codecDescription = this.currentTrack.codecPrivate;
                            }
                            else if (codecIdWithoutSuffix === ebml/* .CODEC_STRING_MAP.eac3 */.oo.eac3) {
                ...
                ;
                break;
            case ebml/* .EBMLId.TrackNumber */.Cl.TrackNumber:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.TrackType */.Cl.TrackType:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagEnabled */.Cl.FlagEnabled:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagDefault */.Cl.FlagDefault:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagForced */.Cl.FlagForced:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagOriginal */.Cl.FlagOriginal:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagHearingImpaired */.Cl.FlagHearingImpaired:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagVisualImpaired */.Cl.FlagVisualImpaired:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FlagCommentary */.Cl.FlagCommentary:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.CodecID */.Cl.CodecID:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.CodecPrivate */.Cl.CodecPrivate:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.DefaultDuration */.Cl.DefaultDuration:
                {
                    if (!this.currentTrack)
                        break;
            ...
            case ebml/* .EBMLId.Name */.Cl.Name:
                ...
                ;
                break;
            case ebml/* .EBMLId.Language */.Cl.Language:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.LanguageBCP47 */.Cl.LanguageBCP47:
                {
                    if (!this.currentTrack)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Video */.Cl.Video:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.PixelWidth */.Cl.PixelWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.PixelHeight */.Cl.PixelHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.DisplayWidth */.Cl.DisplayWidth:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.DisplayHeight */.Cl.DisplayHeight:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.DisplayUnit */.Cl.DisplayUnit:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.AlphaMode */.Cl.AlphaMode:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Colour */.Cl.Colour:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.MatrixCoefficients */.Cl.MatrixCoefficients:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.Range */.Cl.Range:
                {
                    if (this.currentTrack?.info?.type !== 'video' || !this.currentTrack.info.colorSpace)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.TransferCharacteristics */.Cl.TransferCharacteristics:
                {
                    if (this.currentTrack?.info?.type !== 'video' || !this.currentTrack.info.colorSpace)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Primaries */.Cl.Primaries:
                {
                    if (this.currentTrack?.info?.type !== 'video' || !this.currentTrack.info.colorSpace)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Projection */.Cl.Projection:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.ProjectionPoseRoll */.Cl.ProjectionPoseRoll:
                {
                    if (this.currentTrack?.info?.type !== 'video')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Audio */.Cl.Audio:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.SamplingFrequency */.Cl.SamplingFrequency:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Channels */.Cl.Channels:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.BitDepth */.Cl.BitDepth:
                {
                    if (this.currentTrack?.info?.type !== 'audio')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.CuePoint */.Cl.CuePoint:
                {
                    if (!this.currentSegment)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.CueTime */.Cl.CueTime:
                {
                    this.currentCueTime = (0,ebml/* .readUnsignedInt */.dl)(slice, size);
                }
                ;
                break;
            case ebml/* .EBMLId.CueTrackPositions */.Cl.CueTrackPositions:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.CueTrack */.Cl.CueTrack:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.CueClusterPosition */.Cl.CueClusterPosition:
                {
                    const lastCuePoint = this.currentSegment?.cuePoints[this.currentSegment.cuePoints.length - 1];
                    if (!lastCuePoint)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.Timestamp */.Cl.Timestamp:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.SimpleBlock */.Cl.SimpleBlock:
                {
                    if (!this.currentCluster)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.BlockGroup */.Cl.BlockGroup:
                {
                    if (!this.currentCluster)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.Block */.Cl.Block:
                {
                    if (!this.currentCluster)
                        break;
                    const trackNumber = (0,ebml/* .readVarInt */.pT)(slice);
                ...
                ;
                break;
            case ebml/* .EBMLId.BlockAdditions */.Cl.BlockAdditions:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case ebml/* .EBMLId.BlockMore */.Cl.BlockMore:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.BlockAdditional */.Cl.BlockAdditional:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.BlockAddID */.Cl.BlockAddID:
                {
                    if (!this.currentBlockAdditional)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.BlockDuration */.Cl.BlockDuration:
                {
                    if (!this.currentBlock)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.ReferenceBlock */.Cl.ReferenceBlock:
                {
                    if (!this.currentBlock)
                        break;
            ...
            case ebml/* .EBMLId.Tag */.Cl.Tag:
                ...
                ;
                break;
            case ebml/* .EBMLId.Targets */.Cl.Targets:
                {
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case ebml/* .EBMLId.TargetTypeValue */.Cl.TargetTypeValue:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.TagTrackUID */.Cl.TagTrackUID:
            case ebml/* .EBMLId.TagEditionUID */.Cl.TagEditionUID:
            case ebml/* .EBMLId.TagChapterUID */.Cl.TagChapterUID:
            case ebml/* .EBMLId.TagAttachmentUID */.Cl.TagAttachmentUID:
                {
                    this.currentTagTargetIsMovie = false;
                }
                ;
                break;
            case ebml/* .EBMLId.SimpleTag */.Cl.SimpleTag:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.TagName */.Cl.TagName:
                {
                    this.currentSimpleTagName = (0,ebml/* .readUnicodeString */.jR)(slice, size);
                }
                ;
                break;
            case ebml/* .EBMLId.TagString */.Cl.TagString:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.TagBinary */.Cl.TagBinary:
                {
                    if (!this.currentSimpleTagName)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.AttachedFile */.Cl.AttachedFile:
                {
                    if (!this.currentSegment)
                        break;
                    ...
                    if (this.currentAttachedFile.fileUid && this.currentAttachedFile.fileData) {
                        ...
                        tags.raw ??= {};
                        tags.raw[this.currentAttachedFile.fileUid.toString()] = new src_metadata/* .AttachedFile */.VF(this.currentAttachedFile.fileData, this.currentAttachedFile.fileMediaType ?? undefined, this.currentAttachedFile.fileName ?? undefined, this.currentAttachedFile.fileDescription ?? undefined);
                    }
                ...
                ;
                break;
            case ebml/* .EBMLId.FileUID */.Cl.FileUID:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.FileName */.Cl.FileName:
                {
                    if (!this.currentAttachedFile)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FileMediaType */.Cl.FileMediaType:
                {
                    if (!this.currentAttachedFile)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FileData */.Cl.FileData:
                {
                    if (!this.currentAttachedFile)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.FileDescription */.Cl.FileDescription:
                {
                    if (!this.currentAttachedFile)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentEncodings */.Cl.ContentEncodings:
                {
                    if (!this.currentTrack)
                        break;
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentEncoding */.Cl.ContentEncoding:
                {
                    this.currentDecodingInstruction = {
                        order: 0,
                        scope: matroska_demuxer_ContentEncodingScope.Block,
                        data: null,
                    };
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentEncodingOrder */.Cl.ContentEncodingOrder:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentEncodingScope */.Cl.ContentEncodingScope:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentCompression */.Cl.ContentCompression:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.data = {
                        type: 'decompress',
                        algorithm: matroska_demuxer_ContentCompAlgo.Zlib,
                        settings: null,
                    };
                    this.readContiguousElements(slice.slice(dataStartPos, size));
                }
                ;
                break;
            case ebml/* .EBMLId.ContentCompAlgo */.Cl.ContentCompAlgo:
                {
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentCompSettings */.Cl.ContentCompSettings:
                {
                    if (this.currentDecodingInstruction?.data?.type !== 'decompress')
                        break;
                ...
                ;
                break;
            case ebml/* .EBMLId.ContentEncryption */.Cl.ContentEncryption:
                {
                    if (!this.currentDecodingInstruction)
                        break;
                    this.currentDecodingInstruction.data = {
                ...
                case 'decompress':
                    {
                        switch (instruction.data.algorithm) {
                            case matroska_demuxer_ContentCompAlgo.HeaderStripping:
                                {
...
class MatroskaTrackBacking {
    ...
    latestTimestamp, options) {
        ...
        while (segment.elementEndPos === null || currentPos <= segment.elementEndPos - ebml/* .MIN_HEADER_SIZE */.De) {
            ...
            if (!elementHeader
                || (!ebml/* .LEVEL_1_EBML_IDS.includes */.VE.includes(elementHeader.id) && elementHeader.id !== ebml/* .EBMLId.Void */.Cl.Void)) {
            ...
            let size = elementHeader.size;
            const dataStartPos = slice.filePos;
            if (id === ebml/* .EBMLId.Cluster */.Cl.Cluster) {
            ...
            if (size === undefined) {
                ...
                (0,misc/* .assert */.vA)(id !== ebml/* .EBMLId.Cluster */.Cl.Cluster); // Undefined cluster sizes are fixed further up
            ...
            if (segment.elementEndPos === null) {
                ...
                if (elementId === ebml/* .EBMLId.Segment */.Cl.Segment) {
...
class MatroskaVideoTrackBacking extends MatroskaTrackBacking {
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfigPromise ??= (async () => {
            ...
            const config = {
                codec: (0,src_codec/* .extractVideoCodecString */.QP)({
...
class MatroskaAudioTrackBacking extends MatroskaTrackBacking {
    ...
    async getDecoderConfig() {
        ...
        return this.decoderConfig ??= {
            codec: (0,src_codec/* .extractAudioCodecString */.X0)({
                codec: this.internalTrack.info.codec,
                codecDescription: this.internalTrack.info.codecDescription,
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/mp3/mp3-reader.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/mp3/mp3-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class Mp3Demuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
            ...
            if (isXing) {
                ...
                if (!this.xingData) {
                    ...
                    if (xingDataSlice) {
                        ...
                        this.xingData = {
                            frameCount: (flags & mp3_misc/* .XingFlags.FrameCount */.MJ.FrameCount)
                                ? view.getUint32(4, false)
                                : null,
                            fileSize: (flags & mp3_misc/* .XingFlags.FileSize */.MJ.FileSize)
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/ogg/ogg-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class OggDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.bitstreams = [];
    ...
    async readOpusMetadata(firstPacket, bitstream) {
        ...
        bitstream.sampleRate = src_codec/* .OPUS_SAMPLE_RATE */.yo; // Always the same
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/adts/adts-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class AdtsDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
        this.firstFrameHeader = null;
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/flac/flac-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class FlacDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.loadedSamples = []; // All samples from the start of the file to lastLoadedPos
        this.metadataPromise = null;
        ...
        return (this.metadataPromise ??= (async () => {
            ...
            while (this.reader.fileSize === null
                ...
                switch (metaBlockType) {
                    case codec_data/* .FlacBlockType.STREAMINFO */.A3.STREAMINFO: {
                    ...
                    case codec_data/* .FlacBlockType.VORBIS_COMMENT */.A3.VORBIS_COMMENT: {
                    ...
                    case codec_data/* .FlacBlockType.PICTURE */.A3.PICTURE: {
                        // Parse picture block
                        ...
                        const mediaType = misc/* .textDecoder.decode */.su.decode((0,src_reader/* .readBytes */.io)(pictureBlock, mediaTypeLength));
                        const descriptionLength = (0,src_reader/* .readU32Be */.cN)(pictureBlock);
                        const description = misc/* .textDecoder.decode */.su.decode((0,src_reader/* .readBytes */.io)(pictureBlock, descriptionLength));
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/mpeg-ts/mpeg-ts-demuxer.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
...
class MpegTsDemuxer extends src_demuxer/* .Demuxer */.B {
    constructor(input) {
        super(input);
        this.metadataPromise = null;
                        ...
                        switch (streamType) {
                            ...
                            default: {
                                ...
                                if (!ignoredStreamTypes.has(streamType)) {
                                    logging/* .Logging._warn */.y._warn(`Note: MPEG-TS streams with stream_type 0x${streamType.toString(16)} are not`
                                        + ` currently supported.`);
                        ...
                        if (elementaryStream.info.type === 'video') {
                            ...
                            while (true) {
                                ...
                                if (elementaryStream.info.codec === 'avc') {
                                    ...
                                    const spsArray = elementaryStream.info.hevcCodecInfo.arrays.find(a => a.nalUnitType === codec_data/* .HevcNalUnitType.SPS_NUT */.iJ.SPS_NUT);
                            ...
                            if (elementaryStream.info.codec === 'aac') {
                                const slice = src_reader/* .FileSlice.tempFromBytes */.x$.tempFromBytes(context.suppliedPacket.data);
                                const header = (0,adts_reader/* .readAdtsFrameHeader */.lh)(slice);
                                if (!header) {
                                ...
                                const word = (0,src_reader/* .readU32Be */.cN)(src_reader/* .FileSlice.tempFromBytes */.x$.tempFromBytes(context.suppliedPacket.data));
    ...
    async getMimeType() {
        ...
        return (0,mpeg_ts_misc/* .buildMpegTsMimeType */.V)(codecStrings);
    }
    ...
    async readPacket(pos) {
        ...
        const bytes = (0,src_reader/* .readBytes */.io)(slice, (/* inlined export .TS_PACKET_SIZE */188));
...
class MpegTsTrackBacking {
    ...
    createEncodedPacket(suppliedPacket, duration, options) {
        ...
        return new src_packet/* .EncodedPacket */.Z(options.metadataOnly ? src_packet/* .PLACEHOLDER_DATA */.T : suppliedPacket.data, packetType, suppliedPacket.pts / (/* inlined export .TIMESCALE */90000), Math.max(duration / (/* inlined export .TIMESCALE */90000), 0), suppliedPacket.sequenceNumber, suppliedPacket.data.byteLength);
    }
    async getFirstPacket(options) {
    ...
    async doPacketLookup(timestamp, keyframesOnly, options) {
        const searchPts = (0,misc/* .roundIfAlmostInteger */.aI)(timestamp * (/* inlined export .TIMESCALE */90000));
        const demuxer = this.elementaryStream.demuxer;
            ...
            while (true) {
                ...
                while (i < length) {
                    ...
                    if (codec === 'avc') {
                        ...
                        isSlice = nalUnitType === codec_data/* .AvcNalUnitType.NON_IDR_SLICE */.mY.NON_IDR_SLICE
                            || nalUnitType === codec_data/* .AvcNalUnitType.SLICE_DPA */.mY.SLICE_DPA
                            || nalUnitType === codec_data/* .AvcNalUnitType.IDR */.mY.IDR;
                        isAccessUnitStart = nalUnitType === codec_data/* .AvcNalUnitType.SEI */.mY.SEI
                            || nalUnitType === codec_data/* .AvcNalUnitType.SPS */.mY.SPS
                            || nalUnitType === codec_data/* .AvcNalUnitType.PPS */.mY.PPS
                            || nalUnitType === codec_data/* .AvcNalUnitType.AUD */.mY.AUD;
                    }
                    else {
                        ...
                        isSlice = nalUnitType <= codec_data/* .HevcNalUnitType.RASL_R */.iJ.RASL_R
                            || (nalUnitType >= codec_data/* .HevcNalUnitType.BLA_W_LP */.iJ.BLA_W_LP && nalUnitType <= 21);
                        // VPS..FD, prefix SEI, and the reserved/unspecified non-VCL ranges
                        isAccessUnitStart = (nalUnitType >= codec_data/* .HevcNalUnitType.VPS_NUT */.iJ.VPS_NUT && nalUnitType <= 37)
                            || nalUnitType === codec_data/* .HevcNalUnitType.PREFIX_SEI_NUT */.iJ.PREFIX_SEI_NUT
            ...
            while (true) {
                ...
                while (this.currentPos - startPos < remaining) {
                    ...
                    if (codec === 'aac') {
                        ...
                        const header = (0,adts_reader/* .readAdtsFrameHeader */.lh)(src_reader/* .FileSlice.tempFromBytes */.x$.tempFromBytes(headerBytes));
                        if (header) {
                            this.seekTo(possibleHeaderStartPos);
                            let remaining = this.ensureBuffered(header.frameLength);
                            if (remaining instanceof Promise)
                                remaining = await remaining;
                            return this.supplyPacket(remaining, Math.round(SAMPLES_PER_AAC_FRAME * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate));
                        }
                        else {
                        ...
                        if (remaining instanceof Promise)
                            remaining = await remaining;
                        const duration = Math.round(codec_data/* .AC3_SAMPLES_PER_FRAME */.Ir * (/* inlined export .TIMESCALE */90000) / elementaryStream.info.sampleRate);
    ...
    readMetadata() {
        return this.metadataPromise ??= (async () => {
            ...
            const internalTracksByVariant = await Promise.all(variantStreams.map(async (variantStream, i) => {
                ...
                const containsVideoCodecs = codecStrings.some(x => src_codec/* .VIDEO_CODECS.includes */.WN.includes((0,src_codec/* .inferCodecFromCodecString */.oU)(x)));
                const containsAudioCodecs = codecStrings.some(x => src_codec/* .AUDIO_CODECS.includes */.PP.includes((0,src_codec/* .inferCodecFromCodecString */.oU)(x)));
                ...
                for (const codecString of codecStrings) {
                    const inferredCodec = (0,src_codec/* .inferCodecFromCodecString */.oU)(codecString);
                    if (inferredCodec === null) {
                        continue;
                    }
                    if (src_codec/* .VIDEO_CODECS.includes */.WN.includes(inferredCodec)) {
                    ...
                    else if (src_codec/* .AUDIO_CODECS.includes */.PP.includes(inferredCodec)) {
...
class HlsInputVideoTrackBacking extends HlsInputTrackBacking {
    ...
    getCodec() {
        const inferredCodec = (0,src_codec/* .inferCodecFromCodecString */.oU)(this.internalTrack.fullCodecString);
...
;// CONCATENATED MODULE: ./node_modules/mediabunny/dist/modules/src/input-format.js
/*!
 * Copyright (c) 2026-present, Vanilagy and contributors
 *
 * This Source Code Form is subject to the terms of the Mozilla Public
    ...
    async isSupportedEBMLOfDocType(input, desiredDocType) {
        ...
        while (dataSlice.filePos <= startPos + dataSize - ebml/* .MIN_HEADER_SIZE */.De) {
            ...
            if (size === undefined)
                return false;
            switch (id) {
                case ebml/* .EBMLId.EBMLVersion */.Cl.EBMLVersion:
                    {
                    ...
                    ;
                    break;
                case ebml/* .EBMLId.EBMLReadVersion */.Cl.EBMLReadVersion:
                    {
                ...
                case ebml/* .EBMLId.DocType */.Cl.DocType:
                    ...
                    ;
                    break;
                case ebml/* .EBMLId.DocTypeVersion */.Cl.DocTypeVersion:
                    {
...
class Mp3InputFormat extends InputFormat {
    ...
    async _canReadInput(input) {
        ...
        const secondResult = await readNextMp3FrameHeader(input._reader, currentPos, currentPos + (/* inlined export .MP3_FRAME_HEADER_SIZE */4));
        if (!secondResult) {
            return false;
        }
...
/* import */ var _input_format_js__rspack_import_1 = __webpack_require__(5858);
...
class BlobSource extends Source {
    ...
    async _runWorker(worker) {
        ...
        if (reader === undefined) {
            ...
            if ('stream' in this._blob && !(0,_misc_js__rspack_import_0/* .isWebKit */.Tc)() && this._options.useStreamReader !== false) {
